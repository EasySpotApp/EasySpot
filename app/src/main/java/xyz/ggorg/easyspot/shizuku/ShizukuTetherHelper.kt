...
object ShizukuTetherHelper {
    ...
    fun setHotspotEnabledShizuku(
        ...
        return runCatching {
            val tetheringMgr =
                SystemServiceHelper
                    .getSystemService(TETHERING_SERVICE)
    ...
    private fun createTetheringRequest(
        ...
        Class.forName("android.net.TetheringManager\$TetheringRequest\$Builder").run {
    ...
    private fun getRequestParcel(request: Any): Any =
        Class.forName("android.net.TetheringManager\$TetheringRequest").run {
